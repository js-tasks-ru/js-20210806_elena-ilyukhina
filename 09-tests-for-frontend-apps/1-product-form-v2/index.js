...
export default class ProductForm {
  ...
  async render() {
    ...
    try {
      ...
      this.subElements.imageListContainer.append(this.createSortableImageList(product.images));
  ...
  createSortableImageList(data) {
    const sortableList = new SortableList({
      items: data.map(item => this.getImageListItem(item))
    });
